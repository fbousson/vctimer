...
package be.fbousson.voicecontroller.musicg;
...
public class DetectorThread extends Thread {
	...
	private static String TAG = DetectorThread.class.getName();
	...
	public void run() {
		try {
			...
			while (_thread == thisThread) {
				...
				if (buffer != null) {
					// sound detected
					// Log.d(TAG, "whistles found: " + numWhistles);
					// MainActivity.whistleValue = numWhistles;

					// whistle detection
					// System.out.println("*Whistle:");
					boolean isWhistle = whistleApi.isSound(buffer);
	...
	public void resetTotalWhistles() {
